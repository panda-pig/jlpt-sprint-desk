...
`)}var W=p();function G(){let{state:t}=a(),{t:r}=o(),i=t.generatedPlan,c=t.records,[l,u]=(0,M.useState)(`markdown`),[p,h]=(0,M.useState)(``),[g,v]=(0,M.useState)(!1),b=t.profiles.find(e=>e.id===t.activeProfileId)?.name||r(`export.unnamed`),S=e=>{if(!i){h(r(`export.noPlan`));return}switch(e){case`markdown`:h(P(i,c,b));break;case`csv`:h(F(i));break;case`report`:h(I(i,c,b));break;case`backup`:h(H(b,i,t.settings,t.planEdits,c));break;case`print`:h(U(i));break;case`ics`:h(V(i,b));break;default:h(``)}},C=async()=>{if(!p){n(r(`export.genFirst`));return}await d(p),v(!0),n(r(`export.copied2`)),setTimeout(()=>v(!1),2e3)},N=()=>{if(!p){n(r(`export.genFirst`));return}let e={markdown:`jlpt-plan-${b}-${new Date().toISOString().slice(0,10)}.md`,csv:`jlpt-plan-${b}-${new Date().toISOString().slice(0,10)}.csv`,report:`jlpt-report-${b}-${new Date().toISOString().slice(0,10)}.html`,backup:`jlpt-backup-${b}-${new Date().toISOString().slice(0,10)}.json`,print:`jlpt-plan-${b}-${new Date().toISOString().slice(0,10)}.html`,ics:`jlpt-plan-${b}-${new Date().toISOString().slice(0,10)}.ics`};_(e[l]||`export.txt`,p,{markdown:`text/markdown`,csv:`text/csv`,report:`text/html`,backup:`application/json`,print:`text/html`,ics:`text/calendar`}[l]||`text/plain`),n(r(`export.downloaded`,{name:e[l]}))},L=e=>{let i=e.target.files?.[0];if(!i)return;let a=new FileReader;a.onload=()=>{try{let e=JSON.parse(String(a.result));if(e.data&&typeof e.data==`object`)Object.entries(e.data).forEach(([e,t])=>{localStorage.setItem(e,String(t))});else{let n=t.activeProfileId;e.planSettings&&localStorage.setItem(`jlptSprintDesk:${n}:planSettings`,JSON.stringify(e.planSettings)),e.generatedPlan&&localStorage.setItem(`jlptSprintDesk:${n}:generatedPlan`,JSON.stringify(e.generatedPlan)),e.planEdits&&localStorage.setItem(`jlptSprintDesk:${n}:planEdits`,JSON.stringify(e.planEdits)),e.records&&localStorage.setItem(`jlptSprintDesk:${n}:records`,JSON.stringify(e.records))}window.location.reload()}catch{n(r(`export.importError`))}},a.readAsText(i)},R=[{key:`markdown`,label:`Markdown`,desc:r(`export.mdDesc`),icon:O,color:`#315f4f`,ext:`.md`},{key:`csv`,label:r(`export.csvLabel`),desc:r(`export.csvDesc`),icon:A,color:`#35647c`,ext:`.csv`},{key:`report`,label:r(`export.reportLabel`),desc:r(`export.reportDesc`),icon:s,color:`#b77a20`,ext:`.html`},{key:`backup`,label:r(`export.backupLabel`),desc:r(`export.backupDesc`),icon:m,color:`#3d7757`,ext:`.json`},{key:`print`,label:r(`export.printLabel`),desc:r(`export.printDesc`),icon:k,color:`#6d5486`,ext:`.html`},{key:`ics`,label:r(`export.icsLabel`),desc:r(`export.icsDesc`),icon:w,color:`#35647c`,ext:`.ics`}],z=R.find(e=>e.key===l),B=p.length,G=p?p.split(`
`).length:0;return(0,W.jsxs)(`div`,{className:`export-page stack`,children:[(0,W.jsxs)(`section`,{className:`panel export-type-panel`,children:[(0,W.jsx)(`div`,{className:`section-head compact`,children:(0,W.jsxs)(`div`,{children:[(0,W.jsx)(f,{size:`small`,color:`app-teal`,children:r(`export.chooseFormat`)}),(0,W.jsx)(`p`,{children:r(`export.chooseFormatDesc`)})]})}),(0,W.jsx)(`div`,{className:`export-cards`,children:R.map(e=>(0,W.jsxs)(`button`,{type:`button`,className:`export-card ${l===e.key?`active`:``}`,onClick:()=>{u(e.key),S(e.key)},children:[(0,W.jsx)(`span`,{className:`export-card-icon`,style:{background:`${e.color}15`,color:e.color},children:(0,W.jsx)(e.icon,{size:22})}),(0,W.jsx)(`span`,{className:`export-card-label`,children:e.label}),(0,W.jsx)(`span`,{className:`export-card-desc`,children:e.desc}),(0,W.jsx)(`span`,{className:`export-card-ext`,children:e.ext}),l===e.key&&(0,W.jsx)(`span`,{className:`export-card-check`,children:(0,W.jsx)(T,{size:14})})]},e.key))})]}),(0,W.jsx)(x,{type:`line-teal`}),(0,W.jsxs)(`section`,{className:`panel export-preview-panel`,children:[(0,W.jsxs)(`div`,{className:`export-preview-header`,children:[(0,W.jsxs)(`div`,{className:`export-preview-info`,children:[(0,W.jsx)(`span`,{className:`export-preview-icon`,children:(0,W.jsx)(D,{size:18})}),(0,W.jsxs)(`div`,{children:[(0,W.jsx)(`strong`,{children:z?.label||r(`export.exportContent`)}),(0,W.jsx)(`span`,{className:`export-preview-meta`,children:B>0?r(`export.charsLines`,{chars:B.toLocaleString(),lines:G}):r(`export.clickToGen`)})]})]}),(0,W.jsxs)(`div`,{className:`export-preview-actions`,children:[(0,W.jsx)(y,{type:`default`,onClick:C,disabled:!p,icon:(0,W.jsx)(E,{size:15}),children:r(g?`export.copyDone`:`export.copy`)}),(0,W.jsx)(y,{type:`primary`,onClick:N,disabled:!p,icon:(0,W.jsx)(m,{size:15}),children:r(`export.download`)})]})]}),(0,W.jsx)(`textarea`,{className:`export-preview-textarea`,value:p,onChange:e=>h(e.target.value),placeholder:r(`export.outputPlaceholder`),readOnly:!i})]}),(0,W.jsxs)(`section`,{className:`panel import-panel`,children:[(0,W.jsxs)(`div`,{className:`import-header`,children:[(0,W.jsx)(`span`,{className:`import-icon`,children:(0,W.jsx)(e,{size:22})}),(0,W.jsxs)(`div`,{children:[(0,W.jsx)(`h2`,{children:r(`export.importBackup`)}),(0,W.jsx)(`p`,{children:r(`export.importDesc`)})]})]}),(0,W.jsxs)(`div`,{className:`import-body`,children:[(0,W.jsxs)(`div`,{className:`import-upload-zone`,children:[(0,W.jsx)(j,{size:32}),(0,W.jsx)(`span`,{children:r(`export.dropHint`)}),(0,W.jsxs)(`label`,{className:`secondary-button file-button`,children:[r(`export.chooseFile`),(0,W.jsx)(`input`,{type:`file`,accept:`.json`,onChange:L})]})]}),(0,W.jsxs)(`div`,{className:`import-warning`,children:[(0,W.jsx)(e,{size:14}),(0,W.jsx)(`span`,{children:r(`export.irreversible`)})]})]})]})]})}export{G as ExportPage};